...
{
    public class TestTransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EntryDate,EntryOwner")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EntryDate,EntryOwner")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
